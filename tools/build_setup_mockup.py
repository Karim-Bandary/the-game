...
GOVS = [
    ...
    {"id": "dictator", "ic": "🎖️", "nm": "ديكتاتوري", "tag": "شرعيتك من الجيش",
     "desc": "كل السلطة في إيدك. الأحزاب ضعيفة والإعلام مقموع — والجيش — يعني وزير الدفاع — هو الحاجة الوحيدة اللي بتخاف منها.",
     ...
     "bad": ["الرضا بيبدأ −١٠ وبينزل لوحده كل شهر", "دخل الشركات −١٥٪ — مفيش استثمار",
             "⚠️ خط الجيش عندك ٥٤ — أعلى نظام. ولاء وزير الدفاع تحته = خطر انقلاب بيتراكم"],
...
SOCIETIES = [
    ...
    {"id": "tribal", "ic": "🪶", "nm": "مجتمع قبلي عشائري", "tag": "ولاء بدل كفاءة",
     ...
     "mods": {"loyalty": +15, "competence": -2},
     "good": ["ولاء الوزرا بيبدأ +١٥", "رشوة الضباط أرخص ٣٠٪", "المحافظات البعيدة أهدى"],
...
function view(){
  ...
  if(S.gov&&S.gov.id==='dictator') h+='<div class="flag">⚠️ مفيش مؤشر اسمه الجيش — ولاء وزير الدفاع هو الجيش. وخطك ٥٤ مش ٤٠: شرعيتك منهم، فبيتوقعوا أكتر.</div>';
